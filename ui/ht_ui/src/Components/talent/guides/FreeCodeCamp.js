      ...
      <section className="guide mt-32 ">
        <div className="w-full mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-[70%]">
          <div className="flex flex-col justify-center p-5">
            ...
            <ol className="text-2xl text-gray-800">
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  <br />
                  Now click on menu button on top right corner and then you
              ...
              <li>
                <p>
                  ...
                  needs username which is you have here and please note that
                  when you change username then
                  {","}
                  <br />
              ...
              <li>
                <p>
                  When on scrolling below, you will get to see privacy settings
                  as below.
                  <br />
